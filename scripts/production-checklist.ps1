# Production Checklist for storage-api
Write-Host "Production Checklist for storage-api" -ForegroundColor Cyan
...
Test-Requirement "Archive" ((Get-ChildItem -Name "storage-api-v1.0.0-production-certified-*.zip" -ErrorAction SilentlyContinue).Count -gt 0)
