# Certification Archive Generator for storage-api
Write-Host "Generating certification archive for storage-api..." -ForegroundColor Green
...
$CertificationManifest = "# storage-api Certification Manifest
